...
export default function EditFreeTest() {
...
<Sidebar sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} />
      ...
      <div className="relative flex flex-col flex-1 overflow-y-auto overflow-x-hidden">
        ...
        <Header sidebarOpen={sidebarOpen} setSidebarOpen={setSidebarOpen} current={"Edit FreeAssessmentTest"} subparrent={"/FreeAssessmentTest"}/>
        <main>
  ...
  <div class="mb-3 xl:w-96">
    ...
    checked={main_data.is_reverse=="1"?true:false}
        ...
        onChange={()=>{
         ...
         setoptionanight({...main_data,is_reverse:main_data.is_reverse=="1"?false:true}) 
        }}
         />
      <label
